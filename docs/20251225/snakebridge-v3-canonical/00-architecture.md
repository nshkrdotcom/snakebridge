...
│       └── .gitignore                   # Optional: "# Generated by SnakeBridge"
├── .snakebridge/
│   ├── manifest.json                    # Symbol tracking
...
SnakeBridge.Runtime.call(Numpy, :mean, [arr])
    │
    ▼
Snakepit.execute("numpy", "mean", %{a: arr})
    │
    ▼
...
| Doc source | Python authoritative | Accuracy, simplicity |
