# all_functions.exs
# Complete function reference for SnakeBridge.Chardet
# Run with: mix run examples/generated/chardet/all_functions.exs
...
functions = [
  {"detect", 2, :stateless},
  {"detect_all", 3, :stateless}
]

IO.puts("=" |> String.duplicate(60))
IO.puts("  SnakeBridge.Chardet - All Functions")
IO.puts("=" |> String.duplicate(60))
IO.puts("")
