...
defmodule MathVerify do
  ...
  - Requested: ~> 0.1
  - Observed at generation: 0.9.0

  ## Runtime Options

  All functions accept a `__runtime__` option for controlling execution behavior:

      MathVerify.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      MathVerify.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      MathVerify.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      MathVerify.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
