...
# Python module: streaming_example
...
defmodule Streaming do
  ...
  - [Python docs](https://docs.python.org/3/library/streaming_example.html)
  ...
  All functions accept a `__runtime__` option for controlling execution behavior:
      ...
      Streaming.some_function(args, __runtime__: [timeout: 120_000])
  ...
  ### Example with timeout override
      ...
      Streaming.predict(data, __runtime__: [timeout_profile: :ml_inference])

      # Or explicit timeout
      Streaming.predict(data, __runtime__: [timeout: 600_000])

      # Route to a pool and enforce strict affinity
      Streaming.predict(data, __runtime__: [pool_name: :strict_pool, affinity: :strict_queue])
