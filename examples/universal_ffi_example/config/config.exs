...
# Universal FFI Example Configuration
# This example demonstrates no code generation is required -
# all Python calls are done dynamically at runtime.
...
pythonpath =
  [System.get_env("PYTHONPATH"), snakepit_priv, snakebridge_priv]
