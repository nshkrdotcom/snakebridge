# all_functions.exs
# Complete function reference for SnakeBridge.Html
# Run with: mix run examples/generated/html/all_functions.exs
...
functions = [
  {"escape", 2, :stateless},
  {"unescape", 1, :stateless}
]

IO.puts("=" |> String.duplicate(60))
IO.puts("  SnakeBridge.Html - All Functions")
IO.puts("=" |> String.duplicate(60))
IO.puts("")
