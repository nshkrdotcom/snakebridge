# all_functions.exs
# Complete function reference for SnakeBridge.String
# Run with: mix run examples/generated/string/all_functions.exs
...
IO.puts("  SnakeBridge.String - All Functions")
IO.puts("=" |> String.duplicate(60))
IO.puts("")
