# all_functions.exs
# Complete function reference for SnakeBridge.Textwrap
# Run with: mix run examples/generated/textwrap/all_functions.exs
...
IO.puts("  SnakeBridge.Textwrap - All Functions")
IO.puts("=" |> String.duplicate(60))
IO.puts("")
