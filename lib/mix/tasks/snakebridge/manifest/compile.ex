defmodule Mix.Tasks.Snakebridge.Manifest.Compile do
  @moduledoc """
  Compile manifests into Elixir source files.

  ## Usage

      mix snakebridge.manifest.compile [--output DIR] [--load sympy,pylatexenc] [--all] [--clean]
  """

  use Mix.Task

  @shortdoc "Compile manifests into Elixir source files"
  ...
  def run(args) do
    ...
    if clean? and File.dir?(output_dir) do
    ...
    Mix.shell().info("Compiled #{length(outputs)} modules into #{output_dir}")
  end
