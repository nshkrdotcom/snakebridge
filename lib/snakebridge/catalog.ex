defmodule SnakeBridge.Catalog do
  ...
  @catalog [
    ...
    %{
      name: :sympy,
      description: "Symbolic mathematics and algebraic manipulation",
      category: :math,
      pypi_package: "sympy",
      import_name: "sympy",
      version: "1.13.0",
      ...
      last_updated: ~D[2025-12-22]
    },
    %{
      name: :pylatexenc,
      description: "LaTeX parsing and unicode conversion",
      category: :text,
      pypi_package: "pylatexenc",
    ...
    %{
      name: :math_verify,
      description: "Mathematical answer verification utilities",
      category: :math,
      pypi_package: "math-verify",
      import_name: "math_verify",
      version: "0.1.0",
      python_requires: ">=3.9",
      adapter: :generic,
      adapter_module: nil,
